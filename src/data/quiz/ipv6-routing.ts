...
export const ipv6RoutingQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "It drops all IPv6 traffic received on the interface and refuses to process any IPv6 packets.",
      "It acts as an IPv6 host, but will not forward packets between networks or send Router Advertisements.",
      "It forwards packets between networks using connected routes but does not use a dynamic routing table.",
      "It uses IPv4 to route the IPv6 packets, encapsulating them as IPv4 payload to be forwarded.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Routing both OSPF and EIGRP simultaneously on the same physical router interfaces.",
      "Running IPv4 and IPv6 protocols simultaneously on the same network interfaces.",
      "Tunneling IPv6 traffic inside an IPv4 header to send it across an IPv4-only network.",
      "Translating IPv4 addresses to IPv6 so both protocols can share the same address space.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "IPv6 routers fragment packets automatically into 1500 byte chunks when they exceed the MTU.",
      "IPv6 routers do NOT fragment packets; fragmentation is solely the responsibility of the sending host.",
      "IPv6 relies on Layer 2 switches to fragment frames into smaller pieces along the path.",
      "IPv6 does not support fragmentation of any kind, so packets larger than MTU are lost.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A route that includes a host /128 prefix for the destination network address.",
      "A route that specifies BOTH the exit interface AND the next-hop IPv6 address.",
      "A route that points to the internet through the router's default gateway.",
      "A route that uses a global unicast address as the destination of the route.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The loopback address used by the local host",
      "The link-local prefix used for local subnet only",
      "The default route (matches all IP addresses)",
      "The multicast prefix used for one-to-many delivery",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router will drop the packet because it cannot resolve a next-hop MAC address, but it will still keep the static route installed in the routing table.",
      ...
      "The route will be marked with an Administrative Distance of 255 and will be treated as invalid by the router's routing table entirely until removed.",
      "IPv6 will disable the interface and remove all IPv6 configuration from the physical port automatically upon detection of the routing problem.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  // --- Dynamic Routing Protocols: General & Differences ---
  {
    ...
    options: [
      "They no longer use cost or metric to determine the best path to a destination network.",
      "They rely heavily on IPsec for neighbor authentication rather than built-in protocol passwords.",
      "They all use TCP as their transport protocol instead of the UDP or raw IP used in IPv4.",
      "They do not support VLSM, meaning every subnet must use the exact same prefix length.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "No, they use the 128-bit IPv6 address of the highest interface as the Router ID instead.",
      "Yes, they still require a 32-bit Router ID, usually derived from an active IPv4 address.",
      "No, Router IDs are obsolete in IPv6 and are no longer needed for the protocols.",
      "Yes, but it is automatically generated from the router's MAC address using the EUI-64 method.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Using the 'network' command in router configuration mode to advertise the subnets.",
      "By configuring 'ipv6 ospf [process-id] area [area-id]' directly on the interface.",
      "By adding the interface IP address manually to the OSPF neighbor list configuration.",
      "OSPFv3 is automatically enabled on all IPv6 interfaces that have an IPv6 address assigned.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "OSPF starts normally using the lowest MAC address of any physical interface on the router for the Router ID.",
      "OSPF starts but automatically uses the IPv6 loopback address ::1 as its Router ID for the process.",
      "The router throws a syslog error stating 'OSPFv3: Could not allocate router-id' and the process will not run.",
      "The router prompts you to enter a 128-bit IPv6 Router ID before the OSPF process can start at all.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An LSA that floods the entire autonomous system and is seen by every router in the OSPF domain.",
      "An LSA used strictly between routers on a shared local link to advertise Link-Local addresses and prefixes.",
      "An LSA generated by an ASBR to advertise external redistributed routes into the local OSPF domain.",
      "A summary LSA generated by an ABR to advertise routes from one OSPF area to another area.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It replaces the Router LSA (Type 1) and carries the complete topology information for the router.",
      "It carries IPv6 prefix information within an area, decoupling prefix info from topology info.",
      "It advertises external redistributed routes into the OSPF routing domain from other protocols.",
      "It connects two OSPF areas together across the Area Border Router and summarizes their routes.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Mismatched IPv6 subnets on the interfaces",
      "Mismatched MTU (Maximum Transmission Unit)",
      "Duplicate Router IDs on both routers",
      "Wrong multicast address configured for Hellos",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "No, it uses the 128-bit IPv6 address of the loopback interface instead.",
      "No, it uses the MAC address of the lowest interface automatically.",
      "Yes, but it defaults to the 1.1.1.1 address automatically if not set.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The neighbor's calculated metric to reach the destination network.",
      "The router's own total calculated metric to reach the destination.",
      "The physical distance in miles between the two routers.",
      "The maximum hop count allowed along the path to the destination.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The rule that a router must have a unique 32-bit Router ID configured before it can form any neighbor adjacency with a peer on the network.",
      ...
      "The rule that Bandwidth and Delay values must match exactly on both ends of the link in order for the routers to form a neighbor adjacency with each other.",
      "The MTU matching requirement that forces all routers on the same Ethernet segment to use an identical maximum transmission unit frame size to form adjacency.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The primary route installed in the active routing table and used to forward packets for the destination network.",
      "A loop-free backup route kept in the topology table, ready to be used instantly if the Successor fails.",
      "A route that failed the Feasibility Condition and is therefore never kept as a backup alternate path.",
      "A neighbor that went offline and is no longer reachable through the local interface on the shared network segment.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, it is on by default and summarizes routes automatically at classful boundaries.",
      "No, IPv6 is entirely classless, so auto-summary does not exist in EIGRP for IPv6.",
      "Yes, but only for Link-Local addresses on point-to-point serial links between routers.",
      "Yes, but it can be turned off using the 'no auto-summary' command under the process.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To assign IPv6 addresses to end hosts automatically via a stateful DHCPv6 server running on the local network segment.",
      "To filter routing updates, permitting or denying specific IPv6 networks from entering or leaving a routing table.",
      "To block ICMPv6 echo request and echo reply ping traffic from reaching specific destination hosts on the local network segment.",
      "To change the MAC address of a router interface to spoof another device's identity on the local network segment for security testing.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Assign it the highest IPv6 address on the segment.",
      "Configure 'ipv6 ospf priority 255' on the interface.",
      "Configure 'ipv6 ospf priority 0' on the interface instead.",
  ...
  },
  {
    ...
    options: [
      "It forces the router to always be the DR and automatically win the election on that Ethernet segment.",
      "It makes the router a BDR that waits in standby to take over as DR if the current DR on the segment fails.",
      "It prevents the router from ever participating in the DR/BDR election (it stays a DROTHER).",
      "It shuts down OSPF entirely on the interface and stops sending any Hello packets to neighbors.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It drops its OSPF configuration and uses SLAAC to auto-configure its interfaces.",
      "It adds the RA prefix to its OSPF database and redistributes it into the area.",
      "Routers typically ignore RAs by default, as RAs are meant for host autoconfiguration.",
      "It forms an OSPF adjacency with the router that sent the Router Advertisement on the segment.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It remains in the routing table indefinitely until it is manually removed.",
      "It is removed from the routing table immediately if the exit interface goes down.",
      "It waits for the OSPFv3 Dead timer to expire before it is removed from the table.",
      "It is changed to an Administrative Distance of 255 and marked as unusable.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A route used to broadcast traffic to all hosts in the network.",
      "A route that discards (black-holes) traffic matching the prefix.",
      "A route that points back to the sender of the packet.",
      "A route used for management traffic only on the router.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is too high for slow dial-up and legacy low-speed serial links, making their calculated cost values completely inaccurate on those older interfaces.",
      ...
      "It causes MTU mismatches between neighboring routers that use different maximum frame sizes on their connecting serial and Ethernet interfaces at the same time.",
      "It slows down SPF calculation significantly because the computed cost values become very large on high-speed gigabit and 10-gigabit network interfaces.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router will not form an adjacency with its OSPFv3 neighbors on any interface, breaking all neighbor relationships.",
      "It will cause an MTU mismatch and prevent the routers from exchanging database description packets with each other.",
      "It can cause suboptimal routing or routing loops because routers will disagree on the shortest path metrics.",
      "It has no negative effect because the reference bandwidth is only a local calculation value used by each router.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  // --- Advanced Scenarios & Troubleshooting ---
  {
    ...
    options: [
      "The physical cable connecting the routers is broken.",
      "IPv6 unicast-routing is disabled on the router.",
      "There is a subnet mismatch on the Global Unicast Addresses.",
      "The MAC address table on the switch is full.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router successfully formed an adjacency and is actively exchanging route information with the neighboring router on the shared link.",
      "The router has not received a Hello packet from the neighbor within the allowed time, and has torn down the adjacency.",
      "The MTU is mismatched on the interfaces of the two neighboring routers that are exchanging the database description packets with each other.",
      "The Link State Database is full and cannot accept any new link state advertisements that are received from the neighboring router.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The ::/0 route requires a MAC address to be configured in the neighbor discovery table.",
      "The next-hop IP address (2001:db8:a::1) is not reachable via any active interface.",
      "You must use a Link-Local address for the next hop of all static default routes.",
      "Static routes require OSPF to inject them into the routing table of the router.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "They are physical ports on the router that can be unplugged and moved between devices freely.",
      "They are logical, virtual interfaces that are always 'Up' unless administratively shut down.",
      "They cannot be routed by OSPFv3 or included in any dynamic routing process running on the router.",
      "They require a MAC address to be assigned to them before they can pass any network traffic through them.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "From a DHCPv6 server that assigned the address to the neighboring router dynamically.",
      "It is a hardcoded default address that is built into the router's operating system.",
      "It is the Link-Local address of the neighboring router, auto-generated using EUI-64.",
      "It was typed in manually by the network administrator during configuration.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "IPv6 is IP protocol number 6.",
      "IPv6 uses IP protocol number 89.",
      "IPv6 uses TCP port number 80.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To satisfy OSPFv3 requirements, which mandate that a next-hop IP address be included in every static route that is configured on the router at all times.",
      ...
      "To prevent MAC address spoofing attacks from unknown devices on the shared multi-access network segment of the local router's interface, ensuring full trust.",
      "To enable IPv6 multicast routing for multicast groups on the directly connected network segment of the local router's interface in the very first place instead.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A route that failed DAD and was never installed in the table.",
      "A route learned from a rogue router on the network segment.",
      "A route with an Administrative Distance of 255 assigned to it by the admin.",
    ],
    correctAnswer: 0,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: ["OSPFv3 for IPv6", "IS-IS routing protocol", "MP-BGP (Multiprotocol BGP)", "EIGRP for IPv6"],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It looks at the source MAC address of the received frame to determine whether the frame came from a trusted device on the local network segment at all times.",
      "It looks at the TTL or Hop Limit value in the IP packet header to decide whether the packet should be forwarded on to the next hop or dropped completely.",
      "It queries the DNS server to resolve the destination hostname and determine the correct forwarding path for the packet before routing it to the destination.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It routes the packet and changes the Hop Limit to 0 before forwarding it out.",
      "It drops the packet and sends an ICMPv6 Time Exceeded message to the source.",
      "It resets the Hop Limit back to 255 and forwards the packet normally to its destination.",
      "It forwards the packet to the default gateway to be routed further along the path.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
