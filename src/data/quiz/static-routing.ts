...
export const staticRoutingQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "The router forwards the packet back to the source.",
      "The router performs multiple table lookups to resolve the exit interface.",
      "The router drops the packet due to a TTL expiry.",
      "The router switches to a dynamic routing protocol.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "clear ip route 10.1.1.0",
      "delete ip route 10.1.1.0",
      "no ip route 10.1.1.0 255.255.255.0 192.168.1.2",
      "remove route 10.1.1.0",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It changes the AD of the route to 0.",
      "It disables CEF on the interface.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The router throws a configuration error.",
      "Both are installed but only the higher AD is used.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The router must have 'ip routing' disabled.",
      "172.16.1.1 must run OSPF.",
      "The exit interface must be a serial link.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "When the next-hop is a global unicast address",
      "When the exit interface is a point-to-point link",
      "When the next-hop is a link-local address on a multi-access network",
      "When summarizing IPv6 prefixes",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To summarize multiple /24 networks",
      "To act as a default gateway",
  ...
  },
  {
    ...
    options: [
      "The static route remains active.",
      "The static route becomes inactive and is removed from the routing table.",
      "The router switches to the Null0 interface.",
      "The static route's AD dynamically changes.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It forces the router to drop packets with TTL=1.",
      "The router's ARP cache may overflow due to excessive Proxy ARP requests.",
      "It changes the default AD to 255.",
      "It disables Cisco Express Forwarding (CEF).",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router uses the default route to resolve it.",
      "The static route fails the recursive lookup and is not installed.",
      "The router creates a temporary ARP entry.",
      "The router changes the AD to 255.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Because link-local addresses are heavily encrypted.",
      "Because link-local addresses exist on multiple interfaces and are not unique to the router.",
      "Because IPv6 does not support recursive lookups.",
      "Because the AD defaults to 255 without it.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A route that might become active if the primary fails.",
      "A route flagged with an asterisk (*) in the routing table, used as the Gateway of Last Resort.",
      "A route with an AD of 0.",
      "An IPv6 route pointing to FE80::1.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
