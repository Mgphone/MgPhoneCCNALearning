...
export const wirelessQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "To handle real-time RF transmissions and beacon generation on behalf of all joined APs.",
      "To manage authentication, roaming, security policies, and RF management for all joined APs.",
      "To act as a DHCP server and assign IP addresses to all wireless clients on the network.",
      "To physically route packets between VLANs and subnets at full wire speed using dedicated hardware.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "CCK modulation for legacy 802.11b client support",
      "OFDMA (Orthogonal Frequency-Division Multiple Access)",
      "Single-User MIMO supporting one client at a time",
      "WPA2 encryption using a shared pre-shared key",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To serve guest clients only, isolating them onto a separate SSID and VLAN without security policies.",
      "To act as a dedicated sensor for location services, rogue detection, and wIPS, without serving clients.",
      "To capture all wireless packets and forward them to a remote Wireshark server for deep analysis.",
      "To bridge two wired networks together by acting as a transparent Layer 2 link between them.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It connects the WLC to the management VLAN, providing administrative access and monitoring for the controller.",
      "It provides a physical Ethernet port for Access Points to connect to the controller over the wired network.",
      "It is an unroutable IP (default 1.1.1.1) used for mobility management, DHCP relay, and web authentication portals.",
      "It routes traffic between wireless clients on different subnets and VLANs across the enterprise network backbone.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An interface used exclusively for AP image upgrades and firmware management operations on the controller.",
      "An out-of-band management port used for system recovery, troubleshooting, and console access.",
      "A logical interface mapped to a specific VLAN, used to drop client traffic onto the wired network.",
      "An interface that changes its IP address constantly based on the current network conditions and load.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Roaming between APs managed by different WLCs on completely different subnets.",
      "Roaming between APs managed by the same WLC where the WLAN maps to the same subnet.",
      "Roaming using an IPsec tunnel between the wireless client and the foreign WLC.",
      "Roaming that requires the client to re-authenticate fully with the new controller.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It acts as a DHCP server and assigns the client a brand new IP address.",
      "It becomes the Anchor Controller, tunneling traffic to the Foreign Controller.",
      "It drops the client connection to force a DHCP lease renew on the new network.",
      "It hands over its entire MAC address table to the new foreign controller.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To compress wireless frames to reduce bandwidth consumption and improve the overall efficiency of the network.",
      "To legally avoid causing interference to military and weather radar systems operating in the same frequencies.",
      "To load balance wireless clients evenly across all of the available 5 GHz channels in the environment to prevent congestion.",
      "To detect rogue access points operating in the coverage area and immediately block them from the enterprise wireless network.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "CDP (Cisco Discovery Protocol) from the local switch",
      "ARP (Address Resolution Protocol) broadcasts",
      "OSPF (Open Shortest Path First) routing updates",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It disables the radio completely until the SSID is unhidden.",
      "It encrypts the beacon frames so outsiders cannot read the SSID.",
      "It sets the SSID field to null (blank) in its Beacon frames.",
      "It requires the client to use a VPN to connect to the network.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Interference from non-Wi-Fi devices like microwaves, Bluetooth, and cordless phones operating in the 2.4 GHz band.",
      "When APs on overlapping, adjacent channels transmit at the same time causing signal corruption and raising the noise floor.",
      "When multiple APs are configured on the exact same channel, forcing all clients and APs to wait their turn due to CSMA/CA.",
      "When a signal reflects off a wall or other surface and creates multiple delayed copies of the same frame at the receiver.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "When APs are configured on the exact same channel and must contend for airtime using the CSMA/CA mechanism.",
      "When APs transmit on channels that partially overlap (e.g., channels 1 and 2), corrupting each other's data frames.",
      "Interference from non-Wi-Fi devices such as microwaves and Bluetooth gadgets operating in the same physical area.",
      "When an AP is placed too close to a wireless client and overloads the client's receiver with excessive signal energy.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It scans every connected wireless client for viruses and automatically cleans any infected devices to protect the overall network.",
      "It automatically configures WPA3 security on all of the managed access points across the entire wireless network without any manual configuration.",
      "It compresses wireless data to increase the throughput and speed of the wireless network for all connected clients at all times, saving bandwidth.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An AP that has crashed and is no longer transmitting beacon frames to any wireless clients in the area.",
      "An unauthorized access point connected to the corporate network, posing a severe security risk.",
      "An AP configured in monitor mode and acting as a dedicated RF sensor for the wireless network.",
      "An AP operating on the 5 GHz band only to provide wireless coverage to its associated clients.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Port Security (802.1X on the switch)",
      "Peer-to-Peer Blocking (Client Isolation)",
      "VLAN Trunking (802.1Q tagging)",
      "Dynamic ARP Inspection (DAI) protection",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A group of wireless clients that all share the same SSID and connect to the same wireless network at the same time period.",
      "A group of WLCs that share client roaming information and context, allowing seamless roaming across controllers.",
      "A physical group of Access Points that are mounted on the ceiling of a building and provide wireless coverage to the clients below them.",
      "A QoS profile that prioritizes Voice over WLAN traffic above all other data traffic on the wireless network to ensure call quality.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a massive physical appliance to be deployed and managed for just a few access points in the network environment, which is costly and wasteful to operate on-site.",
      "It completely eliminates the need for any controller in the wireless network deployment, at all, regardless of the environment or the total number of access points used.",
      ...
      "It operates entirely over the internet without any local infrastructure or hardware of its own whatsoever being required on the customer premises to function correctly.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To encrypt the data being transmitted over the wireless medium to ensure its confidentiality.",
      "To mitigate the 'Hidden Node' problem by reserving the airtime before transmitting large frames.",
      "To associate the client with the AP and begin the transfer of data frames to the network immediately.",
      "To request an IP address from the DHCP server that is running on the wired network side of the link.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It relies on the Network Allocation Vector (NAV) timer to defer all transmissions on the medium.",
      "It checks the voltage on the copper wire to sense the presence of a carrier signal from another device.",
      "It uses Clear Channel Assessment (CCA) to measure RF energy on the frequency before transmitting.",
      "It sends an ICMP ping to the AP to test the link quality before transmitting any data frames whatsoever.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is the physical carrier sense mechanism that checks the RF energy on the channel before each transmission to ensure that the channel is completely clear.",
      ...
      "It allocates IP addresses to clients from the configured DHCP pool on the network automatically as they connect to the wireless network for the very first time.",
      "It measures the distance to the AP using the round trip time of the transmitted signals back and forth across the wireless medium between the two devices.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It scans the airwaves for unauthorized SSIDs that are broadcasting in the area around the network at all times during its normal day to day operation, hunting for rogues.",
      ...
      "It attempts to hack into nearby APs to discover their security settings and extract their credentials for later use against the corporate wireless network infrastructure.",
      "It captures packets for Wireshark analysis on a connected PC to examine the traffic in detail frame by frame as it passes through the wireless medium of the access point.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The blind spot directly underneath a high-gain antenna where the signal is too weak to be useful for any clients located in that specific zone of the coverage area below the antenna itself.",
      ...
      "The distance before the RF signal drops below the noise floor and becomes completely unusable for any form of communication at all between the two link endpoints involved.",
      "The frequency overlap area between two adjacent channels that causes interference and signal corruption between the two wireless links that are in use at the same time over the medium.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The Lightweight AP handles the DHCP requests on its own locally at the edge.",
      "The WLC acts as a DHCP relay, forwarding the requests to an external DHCP server.",
      "The local access switch handles the DHCP requests instead of the WLC or the AP.",
      "The client uses APIPA to assign itself a private address automatically when nothing responds.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is tunneled back to the WLC via a CAPWAP data tunnel.",
      "It is dropped directly onto the local VLAN at the branch switch.",
      "It is routed over an IPsec VPN to the corporate office.",
      "It is blocked completely until the WLC becomes reachable again.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The AP requires an admin to log in locally to the access point for configuration changes to be applied by hand on the device itself through the CLI interface each time it is needed.",
      ...
      "The AP uses WEP for securing the client connections to the wireless network as its chosen security method for all data traffic being carried by the access point to the core network.",
      "The client authenticates to the switch instead of the AP when it connects to the network for access to the resources it needs to use for its work during the day and beyond that point.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Enterprise uses AES encryption while Personal uses the older and much weaker TKIP method instead of using AES.",
      "Enterprise requires an 802.1X/RADIUS authentication server; Personal uses a single Pre-Shared Key (PSK).",
      "Enterprise cannot be used on the 5 GHz band at all, it is restricted to 2.4 GHz only in the official standards.",
      "Enterprise does not encrypt the data payload being transmitted at all over the air between the client and the AP.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To route guest traffic out to the public internet.",
      "To terminate CAPWAP/LWAPP control tunnels from the APs.",
      "To manage the switch ports on the distribution layer.",
      "To act as the default gateway for wireless clients.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "OSPF multicast flooding of routes",
      "Local Subnet Broadcast (255.255.255.255)",
      "ARP (Address Resolution Protocol) replies",
  ...
  },
  {
    ...
    options: [
      "Spreading the processing load across multiple WLC CPUs for better overall performance of the system as a whole under heavy load conditions at peak times of the day when it is needed most of all, evenly.",
      ...
      "Splitting a client's traffic across the 2.4 GHz and 5 GHz bands simultaneously to use both radios at once for more total bandwidth available to the client device in question overall.",
      "Dropping client packets to reduce the bandwidth being used on the network when it is congested with too much traffic to handle at once on the air interface that is available for use.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To increase the transmit power to maximum at all times for the best possible coverage everywhere in the building and beyond.",
      "To dynamically adjust AP power levels downward to minimize Co-Channel Interference (CCI) and optimize cell sizes.",
      "To save electricity costs by turning the radios down to a lower power level when they are idle and not needed for any traffic at all.",
      "To encrypt the data frames being transmitted to the clients on the wireless network for security purposes at all times of the day.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It assigns IP addresses to the APs from the DHCP pool on the network automatically as they boot up and join the controller for management purposes.",
      "It evaluates RF metrics to automatically change AP channel assignments, avoiding interference and neighboring AP overlap.",
      "It changes the client's MAC address to a different one on the network for privacy and security reasons automatically when it connects to the WLC.",
      "It bonds the 2.4 GHz and 5 GHz channels together for more total throughput and capacity on the wireless link between the client and AP.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A feature that alerts the admin if an AP goes offline or becomes unreachable from the network at any point during its normal day to day operation at the site in question where it is deployed for service to clients using it.",
      ...
      "A feature that blocks rogue APs from connecting to the network and serving clients with an open backdoor into the LAN that sits behind the wireless infrastructure at the site itself where they are discovered by the system automatically.",
      "A feature that redirects guests to a captive portal for authentication before they get access to the network resources that they need to use during their stay at the facility or venue where the wireless network is deployed for guests.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The latency introduced by the CAPWAP tunnel between the AP and WLC during normal day to day operation of the wireless network they are part of as a whole.",
      ...
      "A routing protocol for wireless networks to exchange routes between the devices that are attached to them at the site where they operate in the building or campus.",
      "A feature to delay guest authentication on the network for some period of time after the guest connects to the SSID of the WLAN being offered to them.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "They must be manually mapped to the physical ports on the WLC by the administrator each time they are created.",
      "They are deleted permanently from the WLC configuration without any warning given to the administrator.",
      "They are automatically mapped to the single logical LAG port, and manual port mapping is disabled.",
      "They become management interfaces for the controller instead of remaining as dynamic client interfaces.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The Supplicant (the client device)",
      "The Wireless LAN Controller (WLC) acting as the authenticator",
      "The RADIUS Server (e.g., Cisco ISE or FreeRADIUS)",
      "The Access Point forwarding to the WLC",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The frequency band the antenna uses for its transmissions on the network that it operates within.",
      "The physical orientation of the electric field of the radio wave (e.g., vertical or horizontal).",
      "The strength of the signal being transmitted or received by the antenna at any given moment in time.",
      "The physical length of the antenna element in question on the wireless device that is being mounted.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Sending the same data over different channels to provide redundancy and reliability for the link between the two wireless devices involved in the connection that is being made at the time.",
      ...
      "Compressing the data payload to reduce the size of the frames being sent over the air to the receiving station at the other end of the wireless link in question between the two stations.",
      "Combining the 2.4 GHz and 5 GHz bands into one single link for the client to use at the same time for more total bandwidth and throughput that is available.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A method of bonding channels together to create a single wider channel of bandwidth for higher data rates to be achieved on the wireless link that is in use at the time of the connection being established between the radios themselves in the network.",
      "A security encryption key exchange used to protect the traffic on the link between the two wireless devices that are communicating with each other at the time of the session being held over the wireless medium that connects them together at that very moment in time.",
      "A routing metric used to select the best path through the network for the traffic being carried between the nodes that are involved in the routing decision being made at the time of the request for the route itself in question at hand right now.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To encrypt the wireless frames being sent over the air between the client and the access point to protect them from snooping.",
      "To provide point-to-point Layer 2 encryption on the wired Ethernet link between the Access Point and the switch port.",
      "To block unauthorized MAC addresses from accessing the wireless network and the wired LAN that sits behind the wireless network infrastructure.",
      "To authenticate clients against the RADIUS server before granting them access to the network resources that they need to use.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Meraki requires an on-premise hardware controller to be installed and maintained at each site in order to manage all of the access points and the traffic that they carry for clients.",
      ...
      "Meraki only supports the 2.4 GHz band for all of its access points in the network and nothing else at all beyond that frequency range, period, which is very limiting for the users on it.",
      "Meraki does not support 802.1X authentication for enterprise clients on the network at all, ever, in any configuration that exists today or in the foreseeable future of the product line itself.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To serve Wi-Fi to laptops in a conference room so that they can get internet access for their work during the meeting.",
      "To wirelessly connect two physically separated wired networks (e.g., two buildings) over a dedicated RF link.",
      "To connect a wired PC to a WLC for management purposes through the network directly, much like a physical cable would do for it.",
      "To filter malicious traffic before it reaches the network and the servers that are running on it at the time of the attack.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A RAP is a controller; a MAP is an access point that is managed by the controller it connects to for all of its day to day operations and the traffic that it carries for clients.",
      ...
      "A MAP serves clients; a RAP does not serve any clients at all, ever, under any circumstances whatsoever, period, full stop, no exceptions of any kind whatsoever at all in the network.",
      "A RAP uses 5 GHz; a MAP uses 2.4 GHz for its backhaul connection to the network above it in the mesh hierarchy of the overall topology of the wireless deployment in question.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is encrypted using IPsec in transport mode.",
      "It is encapsulated in UDP and sent unencrypted.",
      "It is encrypted using DTLS keys.",
      "It is sent via TCP for reliability.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Man-in-the-Middle (MitM) attacks on data",
      "Deauthentication (Deauth) Denial-of-Service attacks",
      "Dictionary attacks on the PSK passphrase",
      "VLAN Hopping attacks on the wired network",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A way to crack WEP keys using statistical analysis of the captured packets over a period of time in order to derive the secret key from them.",
      ...
      "A method of bypassing 802.1X authentication on enterprise wireless networks entirely when connecting to them at all, without having any credentials.",
      "A protocol for prioritizing voice traffic over the wireless medium ahead of all other traffic types that are present at the time of the transmission itself.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To request a DHCP address from the server when the client first joins the wireless network that it is connecting to for access to it.",
      "To confirm the successful receipt of a unicast data frame. If the sender doesn't receive an ACK, it retransmits the frame.",
      "To authenticate a user before allowing them onto the wireless network being used for the current session of data that is being carried.",
      "To associate with the AP and begin the data session for the client that has connected to it successfully at that point in time.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Clients cannot see the SSID being broadcast by the access point at all in their scans of the surrounding area around them at any given time.",
      ...
      "The AP drops its CAPWAP tunnel to the controller permanently as a result of the problem occurring on the wireless link between the two devices.",
      "Encryption keys fail to sync between the client and the AP during the handshake process that is happening at that time of the connection being established.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "When a client is too far away to get an IP address from the DHCP server that is running on the network for it to make use of.",
      ...
      "When the WLC is placed across a WAN link from the access points that it manages for the branch office site in question.",
      "When antennas are mismatched in their polarization and gain characteristics with each other on the wireless link that connects the two.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The loss of packets due to a bad cable or connector on the wired link of the network being used for the connection that is at hand right now.",
      ...
      "The loss of signal due to concrete walls absorbing the energy of the radio waves that are passing through them on the way to the receiving device.",
      "The loss of encryption keys over the air during the session of the connection that is in progress at the time of the data transfer being made.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Autonomous APs only support the 2.4 GHz band; lightweight APs support the 5 GHz band exclusively.",
      "Autonomous APs are less secure than lightweight APs in every deployment scenario that exists",
      "There is no difference; they are interchangeable terms for the exact same device in the network today",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
