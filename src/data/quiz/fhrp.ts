...
export const fhrpQuestions: QuizQuestion[] = [
  // --- General FHRP Concepts (1-10) ---
  {
    ...
    options: [
      "To load-balance traffic across multiple internet connections",
      "To provide redundant default gateway availability in case of a single router failure",
      "To encrypt traffic between routers and switches",
      "To assign IP addresses to end devices automatically",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The process of dropping packets when the network is congested.",
      "The ability to dynamically change the virtual IP address based on load.",
      "The transition from a virtual MAC address to a physical MAC address.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To synchronize clocks between the standby and active routers.",
      "To delay the sending of hello packets.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A MAC address assigned dynamically by a DHCP server.",
      "A logical MAC address shared by routers in an FHRP group, associated with the Virtual IP.",
      "The physical MAC address of the switch connected to the routers.",
      "An IPv6 address translated into a MAC format.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To track the MAC addresses of end hosts.",
      "To monitor a WAN uplink and dynamically lower the HSRP priority if the uplink goes down.",
      "To load balance traffic based on interface bandwidth.",
      "To automatically discover other HSRP routers.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Running HSRP and VRRP on the same interface.",
      "Configuring multiple virtual IPs in the same HSRP group.",
      ...
      "Using HSRP on multilink PPP interfaces.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The Standby router reloads repeatedly.",
      "The switch splits the traffic perfectly 50/50.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  // --- HSRP Timers & Tuning (41-55) ---
  {
    ...
    options: [
      "They will not form an HSRP relationship.",
      "They will form a relationship, but it will be unstable and likely flap.",
      "HSRP will automatically negotiate to the higher timers.",
      "HSRP will automatically negotiate to the lower timers.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A security feature that burns the virtual MAC into NVRAM.",
      "A failure state where the virtual MAC is lost.",
  ...
  },
  {
    ...
    options: [
      "The router waits 60 seconds before sending its first hello packet.",
      "The router holds the active state for a minimum of 60 seconds.",
      "If the router recovers from a failure, it will wait 60 seconds before preempting and becoming Active.",
      "The hold timer is set to 60 seconds.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Only physical interfaces can be tracked.",
      "BGP AS paths only.",
      "IP SLA operations (e.g., reachability to an external IP).",
      "Switchport native VLANs.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Only the Virtual IP and Virtual MAC.",
      "A one-line summary per interface showing group, priority, state, active IP, standby IP, and virtual IP.",
      "The detailed tracking decrement values.",
      "The MD5 authentication key-string.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "R1 shuts down its LAN interface.",
      ...
      "R1 immediately sends a 'resign' message and R2 becomes Active regardless of priority.",
      "R2 decrements its priority.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, using the 'standby' command on the switchport.",
      "No, HSRP is a Layer 3 protocol and must be configured on a routed interface or Switch Virtual Interface (SVI).",
      "Yes, but only for IPv6.",
      "No, switches use spanning-tree instead of HSRP.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Using the 'vrrp track interface' command.",
      "It requires configuring an overarching Object Tracker and tracking the object in VRRP.",
      "VRRP does not support any form of tracking.",
      "It tracks interfaces automatically via BGP.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The command is accepted and priority is 100.",
      "The router goes into an err-disable state.",
      "The command is rejected; the IP Address owner must have a priority of 255.",
      "The virtual IP is deleted.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The time it takes for an ARP request to reach the Master.",
      ...
      "The time added to the Hello timer during network congestion.",
      "The delay before Preemption takes effect.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It has faster hello timers by default.",
      "It does not require multicast.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "By changing the virtual IP address dynamically.",
      "By using NAT to translate client IPs.",
      "The AVG replies to ARP requests with different virtual MAC addresses, pointing different clients to different routers.",
      "By using STP to open multiple paths.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is the only router that forwards traffic.",
      "It assigns virtual MAC addresses to AVFs and responds to all ARP requests for the virtual IP.",
      "It serves as a backup to the AVF.",
      "It manages BGP peering.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A standby router waiting for the AVG to fail.",
      "A switch performing Layer 2 forwarding.",
      "The DHCP server for the subnet.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "No, the AVG only handles ARP requests.",
      "Yes, the AVG typically assigns itself a virtual MAC and acts as AVF 1.",
      "Only if there are no other routers available.",
      "Only in IPv6.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
