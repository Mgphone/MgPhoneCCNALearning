...
export const mixedQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "Multimode has a smaller core and is used for much longer distances than single-mode.",
      "Single-mode uses a laser light source and is used for long-distance transmissions.",
      "Single-mode fiber uses LEDs as its light source and is used for short distances.",
      "Multimode fiber supports higher speeds over much longer distances than single-mode.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It drops the frame and updates its MAC address table with the destination entry.",
      "It floods the frame out all active ports in the VLAN except the receiving port.",
      "It sends an ARP request to find the destination MAC address before forwarding.",
      "It forwards the frame to the default gateway to be routed to the destination.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Increases the speed of a switch interface from 100 Mbps to 1 Gbps automatically when the link is up.",
      "Transitions an access port immediately to the Forwarding state, bypassing Listening and Learning.",
      "Aggregates multiple physical ports together into a bundle to provide more total bandwidth.",
      "Disables STP completely on the entire switch so that no ports ever enter the blocking state at all.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Round-robin distribution of each individual packet across all the available links in the bundle.",
      "It sends all traffic over one single link until that link becomes completely full.",
      "By applying a hashing algorithm to frame/packet headers to map flows to specific links.",
      "It broadcasts all of the traffic over all the links to ensure it gets delivered everywhere.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: ["DHCPv6 stateful server", "ICMPv4 echo messages", "NDP (Neighbor Discovery Protocol)", "SLAAC auto-configuration"],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Compresses IPv6 addresses into a shorter format for easier written representation on devices.",
      "Automatically generates a 64-bit Interface ID by manipulating a device's 48-bit MAC address.",
      "Encrypts the IPv6 header to protect the packet contents from being read by attackers while in transit.",
      "Calculates the OSPFv3 metric that is used for best path determination in the routing process.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  // --- IP Routing (Static & Dynamic) ---
  {
    ...
    options: [
      "A measure of the bandwidth capacity available on a given link.",
      "A value representing the trustworthiness or preference of a route source.",
      "The number of hops counted to reach a given destination network.",
      "The maximum physical length that a cable segment can be installed.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A route used for load balancing traffic across multiple equal-cost paths to a destination.",
      "A static route with an AD higher than the primary dynamic protocol, acting as a backup.",
      "A route that changes its next hop dynamically based on link conditions and cost.",
      "A default route that is assigned by a DHCP server to the client automatically at boot.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The Bandwidth and Delay values",
  ...
  },
  {
    ...
    options: [
      "The lowest Router ID of all the routers on the Ethernet segment",
      "The highest interface IP address of the routers, ignoring priority values",
      "Highest OSPF interface priority, then highest Router ID as tie-breaker",
      "The first router to boot up and send a Hello packet on the Ethernet segment",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It disables the interface completely so that no traffic can pass through it at all anymore, and the subnet is no longer advertised to the rest of the OSPF network.",
      ...
      "It turns the interface into a secondary backup path that is only used when the primary path to the destination network fails or goes offline.",
      "It converts the interface to an 802.1Q trunk and allows it to carry multiple VLANs across to the neighboring switch at the same time, changing its role.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A wireless router configuration that broadcasts a Wi-Fi network for wireless clients to join and access the internet through it at once.",
      "A single physical router interface acting as an 802.1Q trunk, using subinterfaces to route traffic between multiple VLANs.",
      "A router configured strictly as a DHCP server to hand out IP addresses to all of the network clients on every VLAN in the network.",
      "A Layer 3 switch configuration that is used to route between networks at hardware speeds using application-specific integrated circuits.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A physical interface on a switch used to connect directly to end devices like PCs and servers.",
      "A logical Layer 3 interface on a multilayer switch used to route traffic for a specific VLAN.",
      "A tunnel interface used to create VPN connections securely over the public internet to remote sites.",
      "A virtual MAC address that is used in HSRP for the standby default gateway group of routers on the segment.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To encrypt DHCP packets so that the information contained in them cannot be read by anyone on the local network segment at all, adding extra security for all clients at boot time.",
      ...
      "To assign static IP addresses to the hosts that connect to the router interface.",
      "To translate private IPs to public IPs when the hosts access the internet.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Mapping one private IP address to one dedicated public IP address from the router's pool of public addresses at a time.",
      "Translating IPv4 addresses to IPv6 addresses using a protocol translation mechanism like NAT64.",
      "Mapping multiple private IP addresses to a single public IP address using unique source port numbers.",
      "Forwarding incoming traffic from the outside internet to an inside private server located on the network.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An unsynchronized clock that has no external time reference source configured on it at all yet.",
      "A server directly connected to an authoritative time source (like an atomic or GPS clock).",
      "A client receiving time updates from an upstream time server located elsewhere on the network.",
      "The highest possible delay value that a time source can experience on the network path at all.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To automatically assign IP addresses to hosts requesting them on the network.",
      "To resolve human-readable domain names (e.g., cisco.com) into IP addresses.",
      "To route packets over the internet to their destination networks.",
      "To synchronize the network time across all of the devices on the network.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To load balance internet traffic across multiple ISP links simultaneously to the wide area network to save on costs.",
      "To provide a highly available default gateway by allowing multiple routers to share a virtual IP and MAC address.",
      "To route traffic faster via application-specific integrated circuits in the switching hardware of the networking device.",
      "To automatically discover neighbor routers and build a complete topology map of the entire network to find the best paths.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "MAC flooding attacks that overflow the switch MAC table",
      "Rogue DHCP servers issuing invalid IP addresses to clients",
      "VLAN hopping attacks across the trunk links of the switch",
      "ARP poisoning attacks directly against the network clients",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  // --- Wireless LANs ---
  {
    ...
    options: [
      "To provide the wireless radio signal physically to the clients within the coverage area of the local network directly.",
      "To centralize the management, configuration, and security of numerous Lightweight Access Points (LAPs).",
      "To route all of the traffic from the wireless clients out to the internet at large, acting as the default gateway.",
      "To act as a RADIUS server for authenticating the wireless users on the network with their credentials at all times.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  // --- QoS & Miscellaneous ---
  {
    ...
    options: [
      "Dropping packets that exceed a configured rate limit on the interface to shape traffic.",
      "Changing the DSCP value in the IP header to mark the traffic with a priority value.",
      "Identifying and grouping traffic based on specific criteria (like IP, port, or protocol).",
      "Storing packets in a buffer during periods of network congestion before sending them out.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An interface used by the applications to talk to the SDN controller and request network services.",
      "An interface used by the SDN controller to communicate with and program the physical network devices.",
      "A web-based GUI for human administrators to manage the network devices by hand instead of using code at all.",
      "An API used strictly for establishing BGP peering sessions between the network routers to exchange routes and prefixes.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A firewall appliance that filters traffic between the different network segments of the enterprise network to provide security at the edge of it.",
      "An intent-based networking controller providing centralized management, automation, and assurance for enterprise networks.",
      "A cloud-only routing protocol that runs between the data center sites over the public internet to provide reachability between all of them.",
      "An Ansible module used to automate the configuration of the network devices on the network using playbooks that are written in the YAML format.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  // --- Deeper Mix / Troubleshooting / Scenarios ---
  {
    ...
    options: [
      "Check the physical cable for any damage or loose connections.",
      "Issue the 'no shutdown' command on the router interface.",
      "Configure a default route on the router for internet access.",
      "Disable the firewall on the router to allow the traffic.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A collision that occurs while operating in full-duplex mode on the link between the connected devices.",
      "A delayed ping response that arrives after the expected time window has passed on the network.",
      "A broadcast storm that floods the network with excessive broadcast and multicast frames.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It drops them immediately without processing any of their contents at all.",
      "It updates its own local VLAN database with the information contained in them.",
      "It forwards them out trunk links to other switches but ignores them locally.",
      "It sends a VTP error message back to the switch that sent the advertisement immediately.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To disable STP on the port to allow instant forwarding of traffic without the 30 second delay at all.",
      "To prevent DTP spoofing attacks by stopping the transmission of dynamic trunking packets.",
      "To force the port into access mode and prevent it from ever becoming a trunk link at all.",
      "To negotiate LACP faster so that the EtherChannel bundle forms quickly without any delay at all.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It completely eliminates the need for physical routers and switches on the entire network at all times, making them completely unnecessary.",
      ...
      "It removes the need for IP addresses on the devices and the entire network, making them completely obsolete for routing purposes entirely at all.",
      "It prevents hardware failures from ever occurring on the network devices at all times in the network infrastructure at large, completely stopping them.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Creates a loopback interface for management and testing purposes on the router at all times when needed.",
      "Configures the router to drop all traffic that arrives at its interfaces immediately, black-holing it.",
      "Creates a gateway of last resort (default route) sending all unknown traffic to 203.0.113.1.",
      "Enables dynamic routing protocols on all of the router's interfaces automatically at boot.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "By rebooting the server that is connected to the affected port entirely.",
      "By issuing the 'shutdown' command followed by 'no shutdown' on the interface.",
      "By changing the VLAN assignment of the port to a different VLAN instead.",
      "By clearing the MAC address table to remove all of the learned addresses from it entirely.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The OSPF route, because the metric of 100 is less than the EIGRP metric of 150000.",
      "The EIGRP route, because EIGRP has a lower Administrative Distance (90 vs 110).",
      "Both routes, because they can be load balanced across the links equally for traffic.",
      "Neither, the router drops the traffic since it cannot decide between the two routes.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To route traffic between the physical servers on the network at the data center efficiently and quickly at all times without delay.",
      "To act as a firewall to filter traffic between the virtual machines running on the host machine entirely, blocking attacks.",
      "To abstract the physical hardware resources (CPU, RAM) and allocate them to multiple Virtual Machines (VMs).",
      "To compile code for SDN applications that run on the network controllers and switches of the fabric at all times, without fail.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
