...
export const networkSecurityQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "To connect devices together within the same local area network (LAN) segment",
      "To forward data packets between different IP networks based on routing tables",
      "To provide wireless network access to wireless endpoints such as laptops",
      "To block unauthorized traffic from entering the network from the outside",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It completely eliminates the need for separate access layer switches entirely in the network design",
      "It combines the core and distribution layers into a single device or layer, reducing cost and complexity",
      "It provides higher security by isolating the distribution layer from the core layer entirely",
      "It allows all endpoints to connect directly to the core layer without any access layer devices",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Layer 2 - Data Link, handling MAC-based frame switching",
      "Layer 3 and Layer 4 - Network and Transport",
      "Layer 1 - Physical, handling raw electrical bit signals",
      "Layer 7 - Application, handling HTTP application payloads",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The network subnet portion of the MAC address",
      "The host identifier portion of the MAC address",
  ...
  },
  {
    ...
    options: [
      "It encrypts the entire IP payload for security purposes before transmission",
      "It determines which part of the IP address is the network portion and which is the host portion",
      "It assigns dynamic IP addresses to endpoints on the local network automatically",
      "It identifies the default gateway address used for traffic leaving the local network subnet",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "UDP establishes a connection first, while TCP sends data without any connection at all",
      "TCP guarantees data delivery and order, UDP provides best-effort delivery without guarantees",
      "TCP is designed exclusively for streaming voice and video, while UDP handles web traffic",
      "UDP operates at Layer 3 for routing, while TCP operates at Layer 4 of the OSI model",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The packet is encrypted before it is forwarded onward",
      "The packet is fragmented into smaller pieces for transport",
      "The packet is dropped and an ICMP 'Time Exceeded' message is sent to the source",
      "The packet is broadcast to all neighboring routers on the network",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To connect physical servers to the local area network segment",
      "To provide a physical firewall between the host operating system and guest OS",
      "To abstract and allocate physical hardware resources to multiple virtual machines",
      "To route traffic between different VLANs on the network",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Type 1 can only run virtual machines with Linux, Type 2 only supports Windows guest VMs entirely",
      "Type 1 is used for running lightweight containers, Type 2 is used for providing full virtual machines",
      "Type 1 always runs inside the public cloud, while Type 2 always runs on-premises in private networks",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It drops the frame immediately and silently discards it without any forwarding attempt",
      "It sends an ICMP destination unreachable message back to the source to report the failure",
      "It floods the frame out of all active ports in the same VLAN, except the port it arrived on",
      "It forwards the frame directly to the default gateway of the network for routing",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It encrypts all data passing over the hub to prevent eavesdropping and password interception attacks",
      "It dynamically assigns unique IP addresses to each host to prevent duplicate address conflicts",
      "It detects when two devices transmit simultaneously, causing a collision, and governs how they retransmit",
      "It ensures full-duplex communication is maintained by automatically negotiating speeds over copper wires",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To resolve human-friendly hostnames to their corresponding IP addresses for clients",
      "To block malicious traffic arriving from the public internet to protect local hosts",
      "To provide a route out of the local subnet for traffic destined for remote networks",
      "To assign IP addresses to all local hosts dynamically using the DHCP protocol",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Containers run completely different operating system kernels on the same physical host with full isolation",
      "Containers require less overhead because they share the host system's OS kernel rather than requiring a full guest OS",
      "Containers provide hardware-level virtualization and a fully separate operating system for each instance",
      "Containers do not require an IP address assigned to them to communicate with each other on the network",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A network segment that is defined by the physical wire length, where collisions between devices can occur",
      "A group of devices all sharing the same physical hub or concentrator to exchange data with each other",
      "A specific set of IP addresses that are reserved exclusively for multicast traffic and group communication",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Providing a virtual machine for a user to install and manage their own operating system and database",
      "Providing a managed environment for developers to build, test, and deploy their application code easily",
      "Delivering a fully functional application over the internet accessible via a web browser (e.g., Office 365, Webex)",
      "Providing raw physical server hardware access in a remote data center that is owned by the customer",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Routing data packets to the correct destination IP address on the network efficiently",
      "Establishing and terminating communication sessions between two hosts on the network",
      "Formatting, encrypting, and compressing data so the application layer can interpret it",
      "Providing the physical electrical signals on the copper wire medium for transmission",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It automatically configures the speed and duplex mode of a switch port to match the capabilities of the connected device",
      ...
      "It automatically assigns a static IP address to the switch's management interface so that it can be accessed remotely for administration",
      "It dynamically assigns the switch port to a specific VLAN based on the MAC address of the connected client device",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Allowing or denying traffic based on TCP and UDP port numbers",
      "Intrusion Prevention Systems (IPS) and Application Visibility/Control (AVC)",
      "Network Address Translation (NAT) for private IP mapping",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Assigning IPv6 addresses dynamically to clients using DHCPv6",
      "Using the exact same subnet mask for all subnets in a routing domain",
  ...
  },
  {
    ...
    options: [
      "By sending a single broadcast packet to every router along the path to request their addresses",
      "By querying the DNS server to look up the router IP addresses for every hop along the path",
      "By intentionally manipulating and incrementing the Time-To-Live (TTL) field in ICMP/UDP packets",
      "By utilizing the TCP Three-Way Handshake to establish a connection with each router on the path",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "SSID is only used for 2.4GHz frequency networks, BSSID is only used for 5GHz frequency networks",
      "SSID is the human-readable network name, BSSID is the MAC address of the Access Point's radio",
      "SSID is used for wireless encryption, BSSID is used for user authentication on the network",
      "SSID is a Layer 3 network routing concept, BSSID is a Layer 4 transport layer concept",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It encrypts the entire data payload for secure transmission over the network using cryptographic keys",
      "It provides flow control by allowing the receiver to tell the sender how much unacknowledged data it can accept",
      "It negotiates the highest possible connection speed between the two hosts for every new communication session",
      "It multiplexes multiple applications over a single transport port by using unique port numbers per stream",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a Wireless LAN Controller (WLC) to manage its configuration and forward all data",
      "It is a standalone device that handles its own management, security, and data forwarding locally",
      "It uses CAPWAP tunnels to pass all wireless client traffic to a central hub for processing",
      "It cannot broadcast an SSID for wireless clients to connect to the network infrastructure",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Running two identical switches in a high-availability failover cluster to provide network redundancy",
      "Configuring a device with both an IPv4 address and an IPv6 address so it can communicate natively on both networks",
      "Using two default gateways configured on a single host device for backup network connectivity failover",
      "Encapsulating IPv6 packets inside IPv4 packets for transport across the existing network infrastructure",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The lowest Administrative Distance (AD) value",
      "The route with the lowest metric value",
      "Longest Prefix Match (Most specific subnet mask)",
      "The highest interface bandwidth available",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Hubs operate at Layer 2 of the OSI model, while switches operate at Layer 1 using electrical signals",
      "Hubs use CSMA/CA to prevent collisions while switches use CSMA/CD for media access control arbitration",
      "Hubs repeat incoming electrical signals out all other ports regardless of MAC addresses, operating at half-duplex",
      "Hubs strip the VLAN tags from incoming Ethernet frames and forward them without any filtering logic at all",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It connects physical routers to the adjacent Internet Service Provider to exchange routing updates and traffic",
      "It logically connects Virtual Machines within the hypervisor to each other and maps them to physical network adapters",
      "It provides routing between different hypervisors on the network using advanced dynamic routing protocols",
      "It acts as a physical hardware replacement for Top-of-Rack access switches deployed in the data center",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The default gateway is reachable and responding to requests from the PC",
      "The DNS server is functioning correctly and resolving hostnames properly",
      "The PC's internal TCP/IP protocol stack is installed and functioning properly",
      "The physical network cable is properly plugged into the PC and connected",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "They are routed across the global public internet like normal addresses and can reach any destination",
      "They are only valid for communications within a single local subnet/broadcast domain and are not forwarded by routers",
      "They are manually assigned by the ISP to each device using a static configuration process rather than DHCP",
      "They begin with the prefix FC00::/7 for unique local addressing within a single organization's private network",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Port 80, the standard well-known TCP port for HTTP traffic",
      "Port 443, the well-known TCP port used for HTTPS traffic",
      "A randomly generated Ephemeral Port (typically between 49152 and 65535)",
      "Port 21, the standard well-known TCP port used for FTP control",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Routing internal traffic via NAT to the internet",
      "Running the Border Gateway Protocol (BGP) with the ISP",
      "Acting as a DHCP server for the local network",
      "Providing a Wireless Access Point for the network",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "UDP requires a 3-way handshake to establish the connection, while TCP does not require one at all",
      "UDP acknowledges every packet sent, while TCP acknowledges only after every 10 packets are received",
      "TCP is connection-oriented and provides sequencing and acknowledgments; UDP is connectionless and best-effort",
      "UDP encrypts the data payload by default, while TCP does not provide any encryption whatsoever",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To identify the version of the IP protocol being used (IPv4 vs IPv6) in the packet header",
      "To identify the upper-layer payload encapsulated within the packet (e.g., 6 for TCP, 17 for UDP)",
      "To establish the priority of the packet for Quality of Service (QoS) marking in the header",
      "To prevent routing loops and the packet from being forwarded endlessly across the network",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Because all network traffic passes through a single core router at the top of the network",
      "Because every leaf switch is exactly one hop away from every other leaf switch via the spine",
      "Because the Spanning Tree Protocol (STP) disables all redundant links in the topology",
      "Because the physical distance between endpoints is limited to 100 meters of cabling",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Establishing network connections between the two hosts",
      "Physical transmission of bits over the wire medium",
      "Data formatting, compression, and encryption/decryption",
      "Assigning logical IP addresses to network devices",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Deploying high-performance enterprise virtual machines in a data center environment",
      "Running a virtual machine on a user's personal laptop that already has Windows 11 installed",
      "Creating a Private Cloud infrastructure to host critical workloads for an organization",
      "Running lightweight application containers using the Docker engine on server hardware",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The switch MAC address table is completely full of entries and cannot store any new addresses",
      "A physical Layer 1 issue, such as a faulty cable, electromagnetic interference, or bad transceiver",
      "An incorrect IP subnet mask configured on the connected PC's network interface settings",
      "A routing protocol misconfiguration in the network",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
