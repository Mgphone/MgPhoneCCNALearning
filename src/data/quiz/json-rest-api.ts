...
export const jsonRestApiQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "It modifies the server state continuously with each request.",
      "Making multiple identical requests has the same effect as making a single request.",
      "The request is fully encrypted.",
      "The method only accepts JSON payloads.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To identify the client's operating system.",
      "To specify the size of the request body.",
      "To provide credentials to authenticate the client to the server.",
      "To authorize the server's SSL certificate.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Authenticating multiple users at once.",
  ...
  },
  {
    ...
    options: [
      "Yes, JSON relies on indentation like Python.",
      "Yes, newlines are strictly forbidden.",
      "No, JSON ignores structural whitespace, allowing it to be minified or 'pretty-printed'.",
      "No, but spaces must replace all tabs.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Nesting an object inside an array",
      "Having a trailing comma after the last key-value pair in an object",
      "Using null as a value",
      "Using an array as the root element",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "JSON encrypted for security.",
      "JSON with all unnecessary whitespace and newlines removed to reduce file size.",
      "JSON converted to binary format.",
      "JSON stripped of array structures.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Parsing a JSON string back into a Python object.",
      "Assigning serial numbers to packets.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A digital certificate installed on a router.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  // --- Automation Tools: Postman, cURL, Python ---
  {
    ...
    options: [
      "It is a Python library for SSH connections.",
      "It is an IDE for writing Python code.",
      "It is a GUI application used to test, build, and interact with REST APIs without writing code.",
      "It is a Cisco proprietary protocol for SD-WAN.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To change the UI theme from light to dark.",
      ...
      "To limit the bandwidth used by API calls.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A CLI tool for configuring Meraki switches via console cables.",
      "A RESTful API used to programmatically manage and monitor Meraki cloud-managed networks.",
      "An SNMP MIB for Meraki routers.",
      "A Python library.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
  ...
  },
  {
    ...
    options: [
      ...
      "Via OAuth 2.0.",
      "Via Basic Authentication encoded in Base64.",
      "Via a dynamically generated JSON Web Token (JWT).",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a Meraki API key.",
      "It uses session-based authentication (Cookies) after posting credentials to the `/j_security_check` endpoint.",
      "It uses no authentication internally.",
      "It requires mutual TLS certificates from the script.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A client polling a server every 5 seconds for updates.",
      "A server-to-server HTTP POST request triggered by an event, acting as a 'reverse API'.",
      "A hardware appliance for filtering REST APIs.",
  ...
  },
  {
    ...
    options: [
      ...
      "The payload is an uploaded file.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Encrypting JSON payloads so they cannot be read.",
  ...
  },
  {
    ...
    options: [
      ...
      "REST is obsolete and SOAP is modern.",
      "SOAP runs over UDP; REST runs over TCP.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The script must use UDP.",
      "The script cannot use variables.",
      ...
      "The script must not save files to the local hard drive.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Restricting the speed of physical switch ports.",
      "An API server restricting the number of API calls a client can make within a specific time window to prevent overload.",
      "Limiting the size of the JSON payload.",
      "Restricting access to certain IP addresses via ACLs.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Halt and delete the API key.",
      "Retry the request immediately and infinitely.",
