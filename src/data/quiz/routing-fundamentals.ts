...
export const routingFundamentalsQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "Broadcasts the packet out all interfaces",
      "Drops the packet and sends an ICMP Destination Unreachable message",
      "Forwards it back to the source",
      "Buffers the packet until a route is learned",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A route that load-balances traffic across multiple links",
      "A static route configured with an Administrative Distance higher than the primary routing protocol",
      "A dynamic route that changes based on bandwidth",
      "A route used exclusively for IPv6",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A route configured with a /32 subnet mask",
      "A route that tracks an SLA",
      "A route distributed via OSPF",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It shuts down the interface completely",
      "It stops sending routing updates out the interface, but still advertises the interface's subnet to other routers",
      "It makes the interface listen-only for ARP requests",
      "It forces the interface into half-duplex mode",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It creates a default static route",
      "It injects the router's existing default route into the OSPF domain",
      "It blocks default routes from entering the router",
      "It changes the OSPF AD to 1",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It creates a new subnet",
      "It identifies which interfaces will participate in OSPF and advertises their connected subnets",
      "It assigns an IP address to a virtual interface",
      "It limits bandwidth to the specified network",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router fragments it anyway",
      "The router ignores the MTU and sends it whole",
      "The router drops the packet and sends an ICMP 'Fragmentation Needed' message",
      "The router changes the DF bit to 0",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To connect to a physical switch",
      "To provide a stable, always-up virtual interface for management and router identification",
      "To load-balance traffic automatically",
      "To prevent Layer 2 bridging loops",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router drops the older route",
      "The router drops the newer route",
      "The router performs Equal-Cost Multi-Path (ECMP) load balancing across both routes",
      "The router enters a routing loop state",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Sending false routing updates to hack a router",
      ...
      "Dropping packets that match a Null0 route",
  ...
  },
  {
    ...
    options: [
      "The route is highly trusted",
      "The route is a directly connected interface",
      "The route is considered untrustworthy and will not be installed in the routing table",
      "The route is learned via iBGP",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To enable OSPF",
      "To assign an IP address to a physical port",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It is faster for the CPU",
      "It bypasses the routing table",
      "It automatically converts to a dynamic route",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To connect two different OSPF areas (e.g., Area 0 and Area 1)",
      "To redistribute routes from another routing domain (e.g., EIGRP or Static) into OSPF",
      "To act as a designated router on an Ethernet segment",
  ...
  },
  {
    ...
    options: [
      ...
      "To connect OSPF to the Internet",
      "To run the BGP protocol",
      "To perform MAC address translation",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router with the highest CPU power",
      "The default route used when a packet's destination does not match any other specific route",
      "The ISP's core router",
      "The final router before a packet is dropped",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Static Variable Interface: A backup physical port",
      "Standard Virtual Identifier: The BGP AS number",
      "Stateful Virtual Inspection: A firewall rule",
    ],
    correctAnswer: 0,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It forces the router to use RIPv1",
      "It enables IPv6",
    ],
    correctAnswer: 1,
    difficulty: "hard",
  ...
  },
  {
    ...
    options: [
      ...
      "It is an SVI",
      "It requires 802.1Q encapsulation",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It supports VLSM",
      "It sends subnet mask information in its routing updates",
  ...
  },
  {
    ...
    options: [
      ...
      "To enable Proxy ARP",
      "To bypass an access control list",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "copy route-table startup-config",
      "write memory",
      "save routing-table",
