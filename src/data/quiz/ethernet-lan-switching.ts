...
export const ethernetLanSwitchingQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "It sends the frame to the default gateway",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It defines the MAC address of the destination.",
      "It indicates the upper-layer protocol encapsulated in the frame payload (e.g., IPv4, IPv6).",
      "It synchronizes the receiving device's clock.",
      "It determines the priority of the frame.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The Universally/Locally Administered (U/L) bit",
      "The last bit of the OUI",
      "The first bit of the FCS",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To block data traffic on a port.",
      "To route traffic between switches.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A VLAN dedicated to transporting CDP and VTP traffic.",
  ...
  },
  {
    ...
    options: [
      ...
      "It drops all management frames.",
      "It carries untagged traffic across the trunk link.",
      "It manages VTP advertisements.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It forces the port to access mode.",
      "It drops untagged frames.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "VTP domains do not match.",
      "Spanning tree is blocking the native VLAN.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A router connected to a hub.",
      "A router using a single physical interface connected to a switch trunk, utilizing subinterfaces to route between VLANs.",
      "A router configured to perform switching functions.",
      "A wireless access point acting as a router.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It will disable all trunk links.",
      ...
      "It will cause a spanning-tree broadcast storm.",
      "It will change the native VLAN to 1002.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It completely eliminates the Learning state.",
      "It uses 'Forwarding' and 'Active' states.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It prevents the switch from ever becoming the Root Bridge.",
      "It ignores all BPDUs.",
  ...
  },
  {
    ...
    options: [
      "The port forwards data but doesn't learn MACs.",
      "The port learns MAC addresses but doesn't forward data.",
  ...
  },
  {
    ...
    options: [
      ...
      "A collision on a full-duplex link.",
      "A collision caused by a slow CPU.",
      "A collision that the switch ignores.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A feature that encrypts data on access ports.",
      ...
      "A feature that requires 802.1X username/password.",
      "A firewall feature applied to VLANs.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
