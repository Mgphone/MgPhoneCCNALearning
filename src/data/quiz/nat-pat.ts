...
export const natPatQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      "To encrypt traffic passing between private and public networks",
      ...
      "To automatically assign private IP addresses to devices on a network",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Translates one private IP address into a single public IP address on a 1-to-1 basis.",
      "Translates multiple public IP addresses into a single private IP using port numbers.",
      "Translates multiple private IPs to a single public IP using unique source port numbers.",
      "Translates hardware MAC addresses into IPv4 IP addresses for the network.",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An access control list (ACL) that blocks all inbound traffic from the internet.",
      "The 'ip nat inside' and 'ip nat outside' commands on the respective interfaces.",
      "A dynamic routing protocol used to advertise the NAT pool routes.",
      "A DHCP pool configuration for assigning IP addresses to the outside network.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router dynamically assigns a 6th public IP address from the configured interface.",
      "The 6th user's connection is dropped until an IP address in the pool becomes available.",
      "The router automatically switches to PAT so the 6th user can share an existing IP.",
      "The router disconnects the first user connection to free up an IP for the 6th user.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A mechanism used to translate 64-bit MAC addresses into IPv4 addresses.",
      "A transition mechanism that allows IPv6 hosts to communicate with IPv4 servers.",
      "A proprietary Cisco NAT protocol designed for large enterprise networks.",
      "An updated version of PAT that supports up to 64,000 concurrent ports.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "By looking at the destination MAC address of the returning data packet.",
      "By tracking the unique Layer 4 destination port number in the returning packet.",
      "By using DPI (Deep Packet Inspection) to read the HTTP header fields.",
      "By verifying the integrity of the packet using IP header checksums.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The actual public IP address of a web server hosted on the internet.",
      "The IP address of an outside host as it appears to the inside network.",
      "The internal private IP address of a host before any NAT translation.",
      "The public IP address assigned to the router WAN-facing interface.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The NAT pool has run out of available public IP addresses for new translations.",
      "The ACL referenced in the NAT statement does not match the internal hosts' IP addresses.",
      "A Static NAT configuration is overriding the dynamic PAT translation table.",
      "The router routing table is missing the routes for the local LAN subnets.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The specific Layer 4 source and destination ports currently being mapped.",
      "The number of active static, dynamic, and extended translations, and total hits/misses.",
      "The exact ACL rules that are currently permitting the NAT traffic to pass.",
      "The remaining lease time for each of the dynamic NAT address allocations.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Forwarding all inbound UDP traffic arriving on the router to a single internal host on the LAN.",
      "A Static NAT configuration that only translates a specific TCP/UDP port rather than the entire IP address.",
      "Allowing multiple internal devices to simultaneously share the same private IP address for internet.",
      "Bypassing the router's routing table to achieve faster hardware-based packet switching on the device.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It causes broadcast storms to propagate throughout the entire network.",
      "An attacker can negotiate a trunk and perform VLAN hopping.",
      "It disables PortFast on all switch ports in the network.",
      "It limits the bandwidth on the port to 10 Mbps by default.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Managing endpoint antivirus software and client security updates.",
      "Providing a centralized GUI controller for Enterprise SDN networks",
      "Acting as a standard BGP route reflector for the enterprise core.",
      "Managing public DNS records and domain name resolution services.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To configure a backup default gateway for clients on the subnet.",
      "To enable the HSRP gateway redundancy protocol on the interface.",
      "To assist OSPF in finding the designated routers on a segment.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Static manual IPv6 address assignment",
      "IPv6 NAT Protocol Translation method",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It ignores the BPDU and keeps the port forwarding.",
      "It becomes the root bridge for the spanning tree domain.",
      "It loses its PortFast status and reverts to normal STP operation.",
      "It drops all traffic on the port and shuts it down permanently.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To act as a high-gain directional antenna for the wireless endpoints.",
      "To centrally manage, configure, and monitor Lightweight Access Points (LAPs).",
      "To route BGP traffic across the wireless spectrum between sites.",
      "To provide a standalone captive portal for Guest Wi-Fi access only.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "SD-WAN uses only satellite connections for all of its WAN transport links to remote branch offices.",
      "SD-WAN centralizes routing policies and separates the control plane from the data plane across WAN links.",
      "Traditional WANs encrypt all of their traffic by default on the underlying transport links.",
      "SD-WAN does not support broadband internet connections as a viable transport at all in its deployments.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The entire trunk link shuts down immediately on both of the switches.",
      "STP blocks the affected ports to prevent the resulting Layer 2 loops.",
      "Traffic on the mismatched VLANs leaks into each other, causing security risks.",
      "CDP automatically disables the trunk and logs an error message.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Monitoring SNMP traps and collecting network management alerts.",
      "Configuration management and enforcement of infrastructure as code.",
      "Load balancing web servers across multiple application nodes.",
      "Handling dynamic routing updates between the network devices.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "EtherChannel port bundling links",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Issue the no shutdown command on the interface alone.",
      "Issue 'shutdown' then 'no shutdown' on the interface.",
      "Issue clear port-security on the affected interface.",
      "Reboot the switch to restore the port operation.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Stateful packet inspection and filtering at the firewall",
      "Access Control Lists for standard packet filtering",
      "Intrusion Prevention System (IPS) and Deep Packet Inspection",
      "NAT capabilities for address translation of traffic",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To create a hierarchical 3-tier core, distribution, and access architecture.",
      "To provide a predictable, non-blocking fabric where every leaf connects to every spine.",
      "To centralize all of the routing decisions on a single core switch device.",
      "To eliminate the need for VLANs within the entire data center fabric network.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To start the OSPF routing protocol process on the device.",
      "To enable Layer 3 routing capabilities on a Layer 3 switch.",
      "To view the routing table on the switch and its contents.",
      "To enable NAT on the switch for the connected networks.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "BPDU Guard protection on the links",
      "Root Guard protection on the links",
  ...
  },
  {
    ...
    options: [
      ...
      "The RD must be equal to or greater than the current Feasible Distance (FD).",
      "The path with the highest cumulative bandwidth is always the feasible successor.",
      "EIGRP does not use a feasibility condition when selecting its backup routes.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It encrypts all traffic crossing the switch ports to prevent eavesdropping on the network.",
      "It requires users to authenticate (via RADIUS/EAP) before granting network access at the switch port.",
      "It automatically configures the switch ports as trunk ports carrying all VLAN traffic.",
      "It mitigates spanning tree loops across the entire campus network switching topology on all ports.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
