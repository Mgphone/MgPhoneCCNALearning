...
export const dnsQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "For all internal network queries",
      "For queries to the root servers only",
      "For zone transfers and responses exceeding 512 bytes",
      "When authenticating via DNSSEC",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A record that resolves to any available IP address.",
      "A record using an asterisk (*) to match requests for non-existent subdomains.",
      "A record that randomly rotates between multiple IP addresses.",
      "A record used exclusively for testing purposes.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It caches queries for local network clients.",
      "It holds the actual, official DNS records for a specific domain.",
      "It forwards all queries to the Root servers.",
      "It strictly filters malicious DNS queries.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A server that only answers queries about its own host.",
      "A server used solely for zone transfers.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It encrypts the DNS payload.",
      "It reduces DNS resolution time and decreases network traffic to authoritative servers.",
      "It prevents DNS spoofing automatically.",
      "It allows administrators to bypass DNS registration fees.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The domain becomes unreachable permanently.",
      "The cached record is deleted, and the resolver must perform a fresh query the next time it is requested.",
      "The DNS server automatically shuts down.",
      "The resolver automatically extends the TTL by 24 hours.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A DNS server that only resolves IPv6.",
      "The DNS client component built into an operating system (like Windows or Linux).",
      "A failed DNS query.",
      "A physical hardware appliance for DNS filtering.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The IP address of www.cisco.com",
      "An NXDOMAIN error",
  ...
  },
  {
    ...
    options: [
      "A method of encrypting DNS queries.",
      "A technique to balance load by returning multiple IP addresses for a single domain in a rotating order.",
      "A protocol for transferring zone files.",
      "A loop prevention mechanism in DNS.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Changing the TLD of a domain.",
      "Forwarding a query from a recursive server to a root server.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "AXFR is for IPv4, IXFR is for IPv6.",
      "AXFR transfers the entire zone, IXFR transfers only the changes (incremental).",
      "AXFR uses UDP, IXFR uses TCP.",
      "AXFR is encrypted, IXFR is plaintext.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  // --- Dynamic DNS & Protocol Mechanics ---
  {
    ...
    options: [
      ...
      "A DNS server that changes its IP address daily.",
      "A protocol to find the fastest DNS server dynamically.",
      "A caching technique.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
  ...
  },
  {
    ...
    options: [
      "A router interface passing DHCP traffic.",
      "A DNS server configured to pass unresolved queries to another specific DNS server rather than querying Root servers.",
      "A switch feature that inspects DNS packets.",
      "A malicious server that redirects traffic.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A network split caused by a routing failure.",
      ...
      "Using two different DNS registrars for redundancy.",
      "Load balancing across multiple TLDs.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It uses the source IP address.",
      "The DNS header contains a 16-bit Transaction ID that must match.",
      "It relies on the TCP sequence number.",
      "It checks the MAC address.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A record that combines IPv4 and IPv6.",
      ...
      "A CNAME that points to another CNAME.",
      "A record used to attach digital signatures.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To secure the router from internet attacks.",
      "To speed up routing protocols.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It traces the physical router hops to the DNS server.",
      ...
      "It logs all DNS traffic locally.",
  ...
  // --- DNS Security & Advanced Protocols ---
  {
    ...
    options: [
      "Overloading a DNS server with traffic to cause a Denial of Service.",
      "Injecting forged DNS data into a resolver's cache so it directs users to a malicious IP address.",
      "Stealing a domain name registration.",
      "Decrypting secure DNS traffic.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "No, it only encrypts the query, not the response.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A failed DNS query.",
      "A router dropping all DNS packets.",
      "A database of expired domains.",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "By guessing the password of the domain registrar.",
      "By sending a small spoofed query to an open resolver, which sends a massive response to the victim's IP, causing a DDoS.",
      "By corrupting the root servers.",
      "By modifying the local HOSTS file on millions of PCs.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  // --- Miscellaneous & Edge Cases ---
  {
    ...
    options: [
      "Changing the authoritative server for a domain.",
      ...
      "Combining two DNS zones into one.",
      "Updating a DHCP lease.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Until the ICANN database updates.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A domain hosted outside the US.",
      "A domain name containing characters from non-Latin scripts (e.g., Arabic, Chinese, Cyrillic).",
      "A domain that resolves to any country.",
      "A domain used by the United Nations.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a special ICANN license.",
      "It conflicts with the mDNS protocol used by Apple Bonjour and Linux Avahi.",
      "It cannot be routed by Cisco routers.",
      "It restricts the network to 254 hosts.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It functions normally like any other alias.",
      "It is illegal by RFC standards to put a CNAME at the root (zone apex).",
      "It speeds up zone transfers.",
      "It provides load balancing automatically.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
