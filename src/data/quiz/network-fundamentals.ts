...
export const networkFundamentalsQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "To inject default routes into the OSPF routing domain",
      "To encrypt all OSPF routing packets while in transit",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To act as a network firewall for the environment",
      "To manage and store container images and apps",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To configure a backup router for failover",
      "To relay DHCP broadcasts to a unicast DHCP server",
      "To assist with NAT address translation",
      "To resolve DNS queries for clients",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A hierarchical three-tier campus network design model",
      "Every leaf connects to every spine, forming a full-mesh backbone",
      "Spines connect directly to end user endpoints",
      "Uses Spanning Tree Protocol to block redundant links",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Spanning tree protocol loops forming",
      "VLAN hopping security attacks",
      "Routing loops between the switches",
  ...
  },
  {
    ...
    options: [
      "Negotiate trunk links between connected switches",
      "Discover neighboring network devices and their capabilities",
      "Route IPv6 traffic between different networks",
      "Encrypt management traffic flowing on the network",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It completely eliminates the need for routing tables on the entire network",
      "It allows subnets of different sizes to be created from the same network space",
      "It secures the network layer with built-in encryption mechanisms",
      "It converts IPv4 addresses to IPv6 format automatically for hosts",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To send data to all nodes on the local network link simultaneously",
      "To route data to a single specific node anywhere in the world uniquely",
      "To send data to the nearest interface among a group sharing the same address",
      "To replace the loopback interface functionality on routers",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To provide end-user access to the network",
      "To apply security and routing policies centrally",
      "To transport large amounts of data quickly and reliably",
      "To manage wireless controllers centrally",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The switch sends an ARP request for the address",
      "The switch floods the frame out all ports except the receiving port",
      "The switch forwards it to the default gateway router",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Prevents dynamically learned MAC addresses from ever aging out of the table",
      "Dynamically learns the connected MAC address and writes it to the running configuration",
      "Restricts the port to a single hard-coded vendor OUI prefix value for identification",
      "Disables dynamic MAC address learning on the entire switch across all ports",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To route packets between different switches on the network",
      "To map logical network topologies using only IP addresses",
      "To discover directly connected Cisco devices and their configurations",
      "To assign VLANs to switch ports dynamically for connected users",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
