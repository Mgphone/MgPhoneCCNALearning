...
export const ciscoIosQuestions: QuizQuestion[] = [
  ...
  // --- Switching & VLANs ---
  {
    ...
    options: [
      ...
      "Sends an ARP request back to the sender",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Configure VTP to route traffic",
      "Configure 'ip forward' on each access port",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To translate voice traffic into data traffic",
      "To separate voice traffic from data traffic on the same switchport",
      "To encrypt VoIP calls",
      "To block data traffic from reaching an IP phone",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To create a VPN between two switches",
      "To prevent Layer 2 loops automatically",
      "To provide power over ethernet (PoE)",
    ],
    correctAnswer: 0,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "To route traffic from one local VLAN to another switch",
  ...
  // --- Routing Fundamentals & Static Routing ---
  {
    ...
    options: [
      ...
      "To calculate the bandwidth of a link",
  ...
  },
  {
    ...
    options: [
      ...
      "A route injected automatically by a DHCP server.",
      "A route used exclusively for load balancing.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Providing an internet connection using a cellular USB stick.",
      "Routing traffic between different VLANs using a single physical router interface and subinterfaces.",
      "Using a router as an Ethernet switch.",
      "Creating a VPN connection to a remote site.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It sets a secondary default gateway.",
      "It relays DHCP broadcasts to a unicast DHCP server at 10.1.1.5.",
      "It configures a backup DNS server.",
      "It translates private IPs to 10.1.1.5.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A device that has lost time synchronization.",
      "A time server directly attached to an authoritative time source (e.g., atomic clock).",
      "A client that receives time from a Stratum 0 server.",
      "A backup NTP server.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
  ...
  },
  {
    ...
    options: [
      "To provide physical wireless signal to endpoints",
      "To centralize management, configuration, and security of multiple access points",
      "To route traffic out to the Internet",
