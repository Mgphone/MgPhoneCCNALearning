...
export const vlansQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "It negotiates a trunk link.",
      "It shuts down administratively (err-disable).",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The trunk link drops and err-disables.",
      "CDP generates Native VLAN mismatch warnings, and STP may block the port to prevent loops.",
      "The switches dynamically negotiate to use VLAN 1.",
      "Traffic flows normally, translating VLAN 10 to 20 automatically.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To negotiate trunk links between switches.",
  ...
  },
  {
    ...
    options: [
      "The new switch had an old VTP password.",
      "The new switch was in VTP Client mode with a revision number of 0.",
      "The new switch was in VTP Server or Client mode with the same domain name and a higher VTP revision number.",
      "The new switch had STP Root Guard enabled.",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Erase the startup-config and reload.",
      "Change the VTP domain name to a bogus name, then change it back.",
      "Change the switch to VTP Server mode.",
      "Issue the 'clear vtp counters' command.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To delete unused VLANs from the VTP database.",
      ...
      "To automatically disable err-disabled ports.",
      "To limit the number of allowed trunks.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It allows a router to act as a wireless access point.",
      "It allows inter-VLAN routing using a single physical router interface divided into multiple logical subinterfaces.",
      "It aggregates multiple physical links into one logical link.",
      "It prevents Spanning Tree loops on a router.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A physical interface on a Layer 3 switch.",
      "A logical Layer 3 interface representing a VLAN, used for inter-VLAN routing or management.",
      "A trunk port carrying multiple VLANs.",
      "A virtual MAC address used by HSRP.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The SVI requires an 'encapsulation dot1q' command.",
  ...
  },
  {
    ...
    options: [
      "SVIs do not require an IP address.",
      ...
      "SVIs automatically configure DHCP.",
      "SVIs eliminate the need for Spanning Tree.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A static trunk carrying all VLANs.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It trusts the Spanning Tree BPDU priority of the phone.",
      "It instructs the switch to trust the QoS CoS values sent by the PC daisy-chained to the phone.",
      "It tells the phone to forward CDP packets.",
      "It trusts DHCP packets from the PC.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "When a switch runs out of MAC address table space.",
      ...
      "When VTP advertises too many VLANs.",
      "When a Voice VLAN overlaps with an Access VLAN.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "To encrypt VLAN traffic using IPsec.",
      "To isolate ports within the same VLAN at Layer 2 so they cannot communicate with each other directly.",
      "To hide the VLAN ID from Wireshark captures.",
      "To tunnel VLANs over an MPLS provider.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A port that accepts untagged traffic.",
      "A port that can communicate with all other ports within the PVLAN (isolated and community).",
      "A port that sniffs traffic (SPAN).",
      "A port that ignores BPDU Guard.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "VLANs only work on IPv6.",
      "Subnets are configured on switches, VLANs on routers.",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A message sent by clients to request specific VLAN info.",
      "A message sent every 5 minutes containing the domain name, version, and configuration revision number.",
      "A packet containing the exact details of every VLAN.",
      "A message used to prune VLANs.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a user to type a password before creating a VLAN.",
      "It encrypts the VTP payload.",
      "It generates an MD5 hash of the VTP message to authenticate the source of the VTP updates.",
      "It restricts console access to the switch.",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The EtherChannel forms successfully.",
      "The EtherChannel fails to form and ports act independently.",
      "The link err-disables.",
      "It falls back to PAgP.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A Layer 2 switch with VTP enabled.",
  ...
  },
  {
    ...
    options: [
      "VLAN 10 is deleted from the global database.",
      "VLAN 10 traffic is blocked from traversing this specific trunk link.",
      "The Native VLAN changes to 10.",
  ...
  },
  {
    ...
    options: [
      "The router's physical interface lacks an IP address.",
      "The switch port connected to the router is configured as an access port instead of a trunk.",
      "VTP is not configured on the router.",
      "Spanning Tree is blocking the router port.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Standard is 1500 bytes. 802.1Q does not change the frame size.",
      "Standard is 9000 bytes. 802.1Q requires Jumbo Frames.",
      "802.1Q fragments the packet.",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It drops all traffic for VLAN 10.",
      "It instructs the router to process untagged frames received on G0/0 as belonging to VLAN 10.",
      "It changes the switch's Native VLAN.",
      "It encrypts VLAN 10 traffic.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It routes them to a different IP.",
      ...
      "It relies on the switch to tag the packets.",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It excludes a VLAN from being routed.",
      "It prevents MAC learning.",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Check the physical cable on the PC.",
      "Check if VTP is synced.",
  ...
  },
  {
    ...
    options: [
      "By using different MAC addresses.",
