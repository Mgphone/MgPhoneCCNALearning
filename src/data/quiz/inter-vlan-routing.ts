...
export const interVlanRoutingQuestions: QuizQuestion[] = [
  // --- Basic Concepts & Legacy Inter-VLAN Routing ---
  {
    ...
    options: [
      ...
      "A router with both ports connected to different switches to route VLAN traffic",
      "A standalone router performing NAT for multiple VLANs to reach the internet",
      "A wireless router providing VLAN segmentation to wireless clients only",
    ],
    correctAnswer: 0,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Using a single trunk link to connect the router to the switch and carry all VLAN traffic across it at once",
      "Using multiple physical router interfaces, with each interface connected to a separate switch access port for each VLAN",
      "Using a wireless bridge to connect the router to the switch and route traffic for multiple VLANs over the air",
      "Using a serial cable to connect the router to the switch and route traffic for every VLAN configured on the network",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It requires a routing protocol like OSPF to be configured on the router",
      "It does not scale well because physical router interfaces are limited and expensive.",
      "It causes broadcast storms to spread throughout the entire switched network",
      "It requires a Layer 3 switch with SVIs to be used instead of a router",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  // --- Router-on-a-Stick (ROAS) Configuration & Concepts ---
  {
    ...
    options: [
      "A physical port added to the router for each VLAN that needs to be routed to the local network",
      "A logical, virtual interface created by dividing one physical interface into multiple logical interfaces",
      "A port on a switch that connects to the router and carries tagged frames for every VLAN on the trunk link",
      "A loopback interface used to test routing between multiple VLANs directly on the router itself",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, the router will reject the configuration if the numbers do not match exactly",
      "No, but it is highly recommended for administrative consistency and troubleshooting.",
      "Yes, it is required by the 802.1Q standard for the subinterface to work",
      "No, subinterfaces cannot be numbered higher than 9 on a single interface",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, it serves as the default gateway for the native VLAN on the trunk link",
      "No, the physical interface typically does not have an IP address in a ROAS setup.",
      "Yes, it must have an IP address to enable routing on the subinterfaces",
      "Yes, but only a loopback IP address can be assigned to the parent interface",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Once, in a single pass across the trunk link to the router",
      "Twice (Up to the router, and back down to the switch)",
      "Three times, crossing the trunk link for each direction of traffic",
      "It does not cross the physical link between the switch and router",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It cannot route IPv6 traffic across the trunk link to the switch because IPv6 is unsupported",
      "The single physical link can become a bottleneck since all inter-VLAN traffic must cross it twice.",
      "It requires a separate physical interface to be used for every single VLAN in the network",
      "It does not support Gigabit speeds on a single physical interface, capping the throughput",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It strips the VLAN 10 tag and forwards the frame out untagged to the switch port",
      "It strips the VLAN 10 tag, routes the packet, and adds a new VLAN 20 tag before sending it out.",
      "It encapsulates the VLAN 10 tagged frame inside a new VLAN 20 tag, creating Q-in-Q",
      "It leaves the VLAN 10 tag intact and routes the packet out with the same tag intact",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, hubs are capable of understanding and preserving the 802.1Q VLAN tags on the wire",
      "No, hubs do not understand or preserve 802.1Q VLAN tags properly, and PCs would see tagged frames.",
      "Yes, but only when using ISL encapsulation on the hub link instead of 802.1Q tagging",
      "No, because routers cannot physically connect to hubs at all, only to switches directly",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Each subinterface generates a unique virtual MAC address for its VLAN at configuration time",
      "All subinterfaces on a physical interface share the same physical MAC address of the parent interface.",
      "Subinterfaces do not have any MAC addresses assigned to them at all by the operating system",
      "Subinterfaces use the MAC address of the connected switch port for all of their outgoing frames",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Up / Down (line up, protocol down)",
      "Down / Down (no line or protocol)",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "No, the switch intercepts the ping and replies on behalf of the router device",
      "No, pings to the default gateway are blocked by the router's configuration settings instead",
      "Yes, but it is dropped by the router before a reply is ever generated back",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It routes normally across the trunk link without any issues at all because the native VLAN is handled correctly",
      "The switch drops the traffic because the native VLAN is not permitted on the trunk link by the configuration",
      "The router drops the traffic because it arrives untagged, and no subinterface is configured to accept untagged traffic.",
      "The router automatically assumes the untagged traffic belongs to VLAN 1 and routes it toward the VLAN 1 subnet",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It creates a bridge between the two subinterfaces for the same VLAN on the port",
      "It balances the load evenly between the two subinterfaces on the port",
      "It rejects the configuration on G0/0.20 because VLAN 10 is already bound to G0/0.10.",
      "It accepts it, but the traffic loops between the two subinterfaces endlessly",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A static route must be configured to reach each subinterface subnet on the router",
      "An IGP like OSPF must be configured between the subinterfaces on the router first",
      "Nothing, they are directly connected routes, so the router routes between them automatically.",
      "NAT must be configured to translate between the two subinterface subnets for routing",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It will be routed normally for VLAN 20 by the router subinterfaces on the trunk",
      "The switch will strip the tags and send the traffic to the router completely untagged",
      "The switch will drop traffic from VLAN 20 because an access port only belongs to one VLAN.",
      "The router will automatically convert the port to a trunk port for you to fix it",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "No, DHCP broadcasts cannot cross a router to reach the DHCP server without the ip helper-address relay",
      "Yes, if the router is configured as a DHCP server, or if 'ip helper-address' is configured on the subinterfaces.",
      "Yes, but only if the DHCP server is located in the Native VLAN of the trunk link being used for ROAS",
      "No, DHCP requires SVIs on a Layer 3 switch to function properly across multiple different VLANs on the switch",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "10, because the interface supports a maximum of ten subinterfaces only",
      "255, which is the limit for subinterfaces on a single router port in IOS",
      "1024, the hardware limit for subinterfaces on Cisco routers is reached",
  ...
  },
  {
    ...
    options: [
      "It shuts them down automatically to prevent any traffic from entering",
      "It uses them only for local management access, acting like a Layer 2 switch.",
      "It drops all traffic that enters the SVIs from the connected hosts",
      "It forwards all traffic from the SVIs to the default gateway router",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The SVI must be assigned a public IP address and a subnet mask so that it can be reached from outside the local network by remote users",
      "A routing protocol must be configured on the switch before the SVI works so it can exchange routing information with its neighbors",
      "The switch must be connected to an external router for the SVI to come up and route traffic to other networks across the campus",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Lower equipment cost than purchasing a separate router for routing in the network",
      "Much higher performance (wire-speed routing via ASICs) and no single-link bottleneck",
      "It supports more routing protocols than a standard router does in the network",
      "It does not require any IP addresses to be configured on it at all for routing",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "An access port configured for a specific VLAN to carry user traffic to the connected end devices in that network segment only",
      "A trunk port carrying multiple VLANs to an external router for routing traffic between the different subnets on the campus network",
      ...
      "A port used exclusively for OSPF to route between the VLANs on the switch and the external routers in the routing domain of the network",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "router rip, which must be enabled to route between the SVIs on the switch",
      "router ospf 1, which is required for the SVIs to exchange routes with each other",
      "No extra commands are needed; directly connected SVIs route automatically.",
      "ip route 0.0.0.0 0.0.0.0, pointing toward the other VLAN subnets to reach them",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "show ip routing to verify the routing table",
      "show running-config | include ip routing",
      "show vlan to check the VLAN configuration",
      "show interface vlan to see the SVI status",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It automatically assigns an IP address to the SVI using DHCP from the configured network server on the segment",
      "It keeps the SVI up even if no physical ports are assigned to the VLAN in the database at all",
      "It automatically brings down the SVI line protocol if no active Layer 2 ports in that VLAN are forwarding.",
      "It enables routing automatically without needing the 'ip routing' command to be configured globally",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  // --- Troubleshooting Inter-VLAN Routing ---
  {
    ...
    options: [
      "A trunk link is down between the switch and the router device carrying the traffic",
      "The PC in VLAN 10 has the wrong default gateway configured on it for the subnet",
      "Routing is not enabled between the two subnets (e.g., missing 'ip routing' on the L3 switch).",
      "The switch port for the PC is in the wrong VLAN on the switch for its subnet assignment",
    ],
    correctAnswer: 2,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The switch port is an access port.",
      "The VLAN ID is wrong.",
      "All of the above.",
    ],
    correctAnswer: 3,
    difficulty: "easy",
  ...
  },
  {
    ...
    options: [
      "The PC needs an IPv6 address to ping the internet successfully",
      "The PC and the default gateway subinterface are on different IP subnets.",
      "The router doesn't have a routing protocol configured on it for the traffic",
      "The trunk port is blocking VLAN 10 from crossing the trunk link to the router",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The SVI instantly goes Up/Up as soon as the VLAN is added to the database",
      "The SVI becomes a routed port instead of a Layer 3 interface on the switch",
      "The switch crashes and loses the entire configuration file immediately",
    ],
    correctAnswer: 0,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It routes faster because the traffic is no longer tagged on the trunk link at all",
      "The switch sends it untagged, but the router expects a tag. The router drops the traffic.",
      "The router automatically strips the tag and processes the traffic without issue",
      "Traffic flows normally without any problem at all on the trunk link to the router",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The router is down and cannot route the traffic between VLANs",
      "The SVIs are down on the Layer 3 switch for VLAN 10",
      "The native VLAN doesn't match between the two switches",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Yes, the switch bridges the connection between the two VLANs",
      "No, a Layer 3 device is required to cross broadcast domain boundaries.",
      "Yes, if they use IPv6 addressing on the same switch ports of the network",
      "Yes, if Proxy ARP is enabled on the PCs by the network administrator",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "No, pings always go to the default gateway before any traffic is sent",
      "Yes, local subnet traffic relies on ARP and MAC addresses, not the default gateway.",
      "Only if the switch has 'ip routing' enabled for the local subnet of the VLAN",
      "Only if the router is online and reachable on the local network segment",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The router crashes because the configuration is invalid and unsupported by the operating system",
      "The physical interface IP handles untagged (native VLAN) traffic, while subinterfaces handle tagged traffic.",
      "The physical IP overrides the IP addresses on all the subinterfaces of the physical interface",
      "The physical interface cannot have an IP address configured on it while subinterfaces exist on the port",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "VLAN 20 is blocked by STP and is not forwarding across the trunk link",
      "VLAN 20 is active, allowed, and successfully forwarding traffic across the trunk.",
      "VLAN 20 is not created in the VLAN database on the local switch at all",
      "VLAN 20 is pruned by VTP from the trunk allowed list on the switch",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It will route normally for VLAN 20 despite the misconfiguration",
      "It will cause confusion, as G0/0.20 is now routing traffic for VLAN 10.",
      "The command will be rejected by the router entirely with an error",
      "It will act as a backup path for the VLAN 10 traffic when needed",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It floods it to all other subinterfaces on the physical interface for the VLANs to process it",
      "It checks if the requested IP matches the IP of G0/0.10, and if so, replies with the router's MAC address.",
      "It forwards it to the internet as a normal routed broadcast toward the destination host on the network",
      "It ignores all ARP requests received on the subinterface without ever responding to any of them",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "VLAN Trunking to the ISP to carry the internet VLAN traffic across the link",
      "A default route (e.g., 'ip route 0.0.0.0 0.0.0.0') pointing to the ISP's IP",
      "Subinterfaces on the routed port for each internal VLAN to be routed",
      "A dynamic MAC address learned from the ISP device on the routed port",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "SVIs don't use any ports, so all of the physical ports stay available for connecting end users to the network",
      "SVIs require more physical ports than a router-on-a-stick setup requires in the overall network design today",
      "A Layer 3 switch typically has 24-48 physical ports built-in, whereas routers have fewer, requiring external switches.",
      "ROAS does not require a switch at all in the network design for inter-VLAN routing to work properly at all",
    ],
    correctAnswer: 2,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Leave it as VLAN 1 and do not configure it on the router subinterfaces so that the traffic is dropped by the router entirely",
      ...
      "Configure the router to tag the native VLAN frames on the trunk so that they are no longer sent untagged to the switch",
      "Disable the native VLAN entirely on the switch and the router so that no untagged traffic is used on the trunk link at all",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "No, routers only support trunking and never act as access ports for a single VLAN on the network at all, unlike switches",
      ...
      "Only if the 'switchport' command is used on the router interface to enable the access port functionality in the software",
      "Only for VLAN 1, the default native VLAN on the switch that carries the untagged traffic by default on the trunk link port",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The switch MAC table overflows and drops frames intermittently",
      "BGP drops the traffic because the route is not in the table",
      "The router CPU hits 100% utilization and drops all routed traffic",
    ],
    correctAnswer: 0,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The size of the packet determines which switching path is used by the switch for the packet",
      "CEF is enabled by default. Only unsupported features or complex packets fall back to the CPU.",
      "The 'ip routing' command dictates which path the switch will use for the traffic",
      "SVIs use CEF, while routed ports always use the CPU path for the routing decisions",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "It must go through an external router to reach the routed port on the multilayer switch",
      "The switch routes it internally from the SVI to the routed port via its backplane routing table.",
      "It bridges the traffic at Layer 2 between the two interfaces on the same switch port",
      "It uses NAT to translate between the SVI and the routed port IP addresses on the switch",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "A feature where a switch acts as a DHCP server for the network and hands out IP addresses to the hosts on it",
      "A feature where a router answers an ARP request on behalf of a destination host if the router has a route to that host.",
      "A protocol to sync ARP tables between different switches so that they stay in agreement with each other on the network",
      "A security feature that blocks ARP spoofing on the network by validating the ARP requests received from the hosts",
    ],
    correctAnswer: 1,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Proxy ARP disables the trunk link between the switches so inter-VLAN traffic stops flowing and all hosts lose connectivity to remote subnets immediately on the change",
      "Proxy ARP changes the IP addresses of all the hosts on the network to new ones so that they no longer match the configured default gateways on the network at all",
      ...
      "Proxy ARP drops all of the ICMP traffic between the different VLANs on the network so that pings always fail even when inter-VLAN routing is working correctly for all the hosts",
    ],
    correctAnswer: 2,
    difficulty: "hard",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The tag is forwarded to the routed port unchanged and intact for the frame",
      "The switch strips the VLAN tag because routed ports do not process VLAN tags.",
      "The switch changes the tag to VLAN 1 before sending it out on the port",
      "The packet is dropped because routed ports cannot route the tagged traffic",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "Buy another router with more physical interfaces to use for the VLANs",
      "Use Router-on-a-Stick with subinterfaces on one of the physical interfaces.",
      "Use legacy routing and combine two VLANs on one single physical port",
      "You cannot route 6 VLANs with only 4 physical interfaces available",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The native VLAN configured on the switch trunk port",
      "The 'ip address' command applied to the subinterface.",
      "The switch's VTP configuration determines the subnet mask",
      "The DHCP server assigns the subnet mask automatically",
    ],
    correctAnswer: 1,
    difficulty: "easy",
    explanation:
  ...
  },
  {
    ...
    options: [
      "The switch is blocking ICMP traffic on the access port with an access control list",
      "The router drops the first packet while waiting for the ARP resolution process to complete.",
      "The trunk link is negotiating between the switch and the router at the time of the ping",
      "Spanning tree is recalculating and blocking the port during the convergence period",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
  ...
  },
  {
    ...
    options: [
      "VTP Server mode, DTP auto, and STP Portfast configured on the switches in the network design",
      "'ip routing' enabled, SVIs configured with IP addresses, and active Layer 2 ports assigned to those VLANs",
      "Router-on-a-stick, subinterfaces, and static default routes on the router for the routing task",
      "NAT, Access Control Lists, and default routes configured on the network devices in the network properly",
    ],
    correctAnswer: 1,
    difficulty: "medium",
    explanation:
